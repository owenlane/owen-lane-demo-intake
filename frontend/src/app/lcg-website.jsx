  ...
  return<>
    ...
    <Sec><W><div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-start">
      <div className="lg:col-span-5"><V><div className="space-y-8">
        <div><p className="text-[9.5px] tracking-[0.22em] uppercase font-medium mb-2" style={{color:EM,fontFamily:SA}}>Email</p><a href="mailto:contact@lanecamposgroup.com" className="text-white text-[14.5px] hover:underline underline-offset-4 decoration-white/20" style={{fontFamily:SA,fontWeight:300}}>contact@lanecamposgroup.com</a></div>
